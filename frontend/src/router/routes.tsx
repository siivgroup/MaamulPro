...
const RentalUnitsPage = lazy(() => import('../pages/RentalUnitsPage'));
const TenantRentalProfilePage = lazy(() => import('../pages/TenantRentalProfilePage'));
const RentPaymentsPage = lazy(() => import('../pages/RentPaymentsPage'));
const PropertySalesPage = lazy(() => import('../pages/PropertySalesPage'));
import { dealFields, propertyFields, rentalContractFields, rentalUnitCategoryFields } from '../pages/realEstateConfig';
...
import { customerFields, materialFields, purchaseFields, saleFields, supplierEditFields, supplierFields, transportationFields } from '../pages/materialsConfig';
...
const routes = [
    ...
    { path: '/app/real-estate/properties/:id', element: <EntityDetailPage titleKey="title" endpoint="/api/real-estate/properties" backTo="/app/real-estate/properties" editTo={(id) => `/app/real-estate/properties/${id}/edit`} editPermission="properties.update" imageKey="imageUrl" statusKey="status" primaryFields={['type', 'description', 'address', 'price', 'area', 'floors']} moneyKeys={['price', 'totalAmount', 'paidAmount', 'monthlyRent', 'amount']} dateKeys={['closedAt', 'startDate', 'endDate', 'date']} sections={[{ key: 'deals', title: 'Property records' }, { key: 'rentalContracts', title: 'Rental contracts' }, { key: 'tenants', title: 'Tenants' }, { key: 'transactions', title: 'Financial transactions' }]} relatedActions={[{ label: 'Create sale', to: (id) => `/app/real-estate/sales/new?propertyId=${id}`, permission: 'deals.create' }, { label: 'New lease', to: (id) => `/app/real-estate/rental-contracts/new?propertyId=${id}`, permission: 'rentals.create' }]} />, layout: 'blank', permission: 'properties.read' },
    { path: '/app/real-estate/deals', element: <CrudPage title="Property Sales" description="Sale contracts, settlement status, and financial-ledger state." endpoint="/api/real-estate/deals" createPermission="deals.create" updatePermission="deals.update" deletePermission="deals.delete" createTo="/app/real-estate/deals/new" editTo={(id) => `/app/real-estate/deals/${id}/edit`} fields={dealFields} />, layout: 'blank', permission: 'deals.read' },
    { path: '/app/real-estate/deals/new', element: <CrudRoutePage title="New property sale" description="Record the sale price and amount received. Create rentals from the Rentals workspace as a lease." endpoint="/api/real-estate/deals" fields={dealFields} initialMode="create" returnTo="/app/real-estate/deals" />, layout: 'blank', permission: 'deals.create' },
    { path: '/app/real-estate/deals/:id/edit', element: <CrudRoutePage title="Edit property sale" description="Update the sale price, amount received, and closing notes." endpoint="/api/real-estate/deals" fields={dealFields} initialMode="edit" returnTo="/app/real-estate/deals" />, layout: 'blank', permission: 'deals.update' },
    ...
    { path: '/app/real-estate/sales/new', element: <CrudRoutePage title="New property sale" description="Record the sale price and amount received." endpoint="/api/real-estate/deals" fields={dealFields} initialMode="create" returnTo="/app/real-estate/sales" />, layout: 'blank', permission: 'deals.create' },
    { path: '/app/real-estate/sales/:id/edit', element: <CrudRoutePage title="Edit property sale" description="Update the sale price, amount received, and closing notes." endpoint="/api/real-estate/deals" fields={dealFields} initialMode="edit" returnTo="/app/real-estate/sales" />, layout: 'blank', permission: 'deals.update' },
    { path: '/app/real-estate/sales/:id', element: <EntityDetailPage titleKey="type" endpoint="/api/real-estate/deals" backTo="/app/real-estate/sales" editTo={(id) => `/app/real-estate/sales/${id}/edit`} editPermission="deals.update" statusKey="paymentStatus" primaryFields={['totalAmount', 'paidAmount', 'closedAt', 'notes']} moneyKeys={['totalAmount', 'paidAmount', 'amount']} dateKeys={['closedAt', 'date']} sections={[{ key: 'transactions', title: 'Financial transactions' }]} />, layout: 'blank', permission: 'deals.read' },
    { path: '/app/real-estate/rentals', element: <RentalHubPage />, layout: 'blank', permission: 'rentals.read' },
    { path: '/app/real-estate/units', element: <RentalUnitsPage />, layout: 'blank', permission: 'rentals.read' },
    { path: '/app/real-estate/unit-categories', element: <CrudPage title="Unit Categories" description="Set rooms, bathrooms, rent fee, and section once for every unit in a category." endpoint="/api/real-estate/unit-categories" createPermission="rentals.create" updatePermission="rentals.update" deletePermission="rentals.delete" fields={rentalUnitCategoryFields} />, layout: 'blank', permission: 'rentals.read' },
    { path: '/app/real-estate/tenants/:id/rental-profile', element: <TenantRentalProfilePage />, layout: 'blank', permission: ['clients.read', 'rentals.read'] },
    { path: '/app/real-estate/clients', element: <CrudPage title="Clients" description="Buyer, seller, investor and tenant contact directory, shared by sales and rental contracts." endpoint="/api/real-estate/tenants" createPermission={['clients.create', 'rentals.create']} updatePermission={['clients.update', 'rentals.update']} deletePermission={['clients.delete', 'rentals.delete']} viewTo={(id) => `/app/real-estate/tenants/${id}/rental-profile`} fields={[
    ...
    { path: '/app/real-estate/rental-contracts/new', element: <CrudRoutePage title="New rental contract" description="Create a lease agreement for one available unit with billing terms." endpoint="/api/real-estate/rental-contracts" fields={rentalContractFields} initialMode="create" returnTo="/app/real-estate/rentals" />, layout: 'blank', permission: 'rentals.create' },
    ...
    { path: '/app/real-estate/rent-payments', element: <RentPaymentsPage />, layout: 'blank', permission: 'rentals.read' },
    ...
    { path: '/app/materials/suppliers/:id/edit', element: <CrudRoutePage title="Edit supplier" description="Update supplier contact details." endpoint="/api/materials/suppliers" fields={supplierEditFields} initialMode="edit" returnTo="/app/materials/suppliers" />, layout: 'blank', permission: 'suppliers.update' },
    { path: '/app/materials/suppliers/:id', element: <SupplierProfilePage />, layout: 'blank', permission: 'suppliers.read' },
    { path: '/app/materials/purchases', element: <CrudPage title="Purchase Orders" description="Orders with received-stock, weighted-cost and supplier-ledger synchronization." endpoint="/api/materials/purchases" createPermission="purchases.create" updatePermission="purchases.update" deletePermission="purchases.delete" createTo="/app/materials/purchases/new" editTo={(id) => `/app/materials/purchases/${id}/edit`} viewTo={(id) => `/app/materials/purchases/${id}`} canEdit={(row) => ['DRAFT', 'ORDERED'].includes(row.status)} canDelete={(row) => ['DRAFT', 'CANCELLED'].includes(row.status)} fields={purchaseFields} />, layout: 'blank', permission: 'purchases.read' },
    ...
    { path: '/app/materials/purchases/:id', element: <PurchaseOrderPage />, layout: 'blank', permission: 'purchases.read' },
